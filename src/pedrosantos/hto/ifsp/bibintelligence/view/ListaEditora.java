 ...
 * @author lndosnw
 */
public class ListaEditora extends javax.swing.JFrame {
     ...
     */
    private ListaEditora() {
        initComponents();
        modelo = (DefaultTableModel) tblEditoras.getModel();
    }

    private static ListaEditora instancia;
    public static ListaEditora getInstancia(){
        if (instancia == null){
            instancia = new ListaEditora();
        }
        return instancia;
    }
    ...
    private void initComponents() {
        ...
        tblEditoras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "idEditora", "nome", "endereço", "telefone", "site", "desativado"
            }
        ) {
        ...
        tblEditoras.setColumnSelectionAllowed(true);

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, Livros, org.jdesktop.beansbinding.ObjectProperty.create(), tblEditoras, org.jdesktop.beansbinding.BeanProperty.create("elements"));
        bindingGroup.addBinding(binding);
        binding.bind();
        jspLivros.setViewportView(tblEditoras);
        tblEditoras.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if(tblEditoras.getSelectedRow() != -1){
            ...
            cadeditora.nome = (String) modelo.getValueAt(tblEditoras.getSelectedRow(), 1);
            cadeditora.endereco = (String) modelo.getValueAt(tblEditoras.getSelectedRow(), 2);
            cadeditora.telefone = (long) modelo.getValueAt(tblEditoras.getSelectedRow(), 3);
            cadeditora.site = (String) modelo.getValueAt(tblEditoras.getSelectedRow(), 4);
            cadeditora.idEditora = BibIntelligence.VerificaID("SELECT idEditora from editoras where nome=\""+cadeditora.nome+"\"", "idEditora",1);
            cadeditora.setVisible(true);
            /*
            cadusuario.nome = (String) modelo.getValueAt(tblLivros.getSelectedRow(), 1);
            cadusuario.endereco = (String) modelo.getValueAt(tblLivros.getSelectedRow(), 2);
            cadusuario.telefone = (long) modelo.getValueAt(tblLivros.getSelectedRow(), 3);
            cadusuario.site = (String) modelo.getValueAt(tblLivros.getSelectedRow(), 4);
            cadusuario.erros = (int) modelo.getValueAt(tblLivros.getSelectedRow(), 6);
            cadusuario.bloqueado = (boolean) modelo.getValueAt(tblLivros.getSelectedRow(), 7);
            cadusuario.desativado = (boolean) modelo.getValueAt(tblLivros.getSelectedRow(), 8);
    ...
    private void btAtivaDesativaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtivaDesativaActionPerformed
        ...
        if(ativa==0){
            ativa=1;
            BibIntelligence.AtvDestvEditora(ativa, (int) tblEditoras.getValueAt(tblEditoras.getSelectedRow(), 0));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        if(ativa==0){
            try{
                    String SQL = "call listaEditorasAtivas";
                    while(Conexao.getResultSet(SQL).next()){
                        modelo.addRow(new Object[]{Conexao.getRsInt("idEditora"), Conexao.getRsString("nome"), Conexao.getRsString("endereco"), Conexao.getRsLong("telefone"), Conexao.getRsString("site"), Conexao.getRsBoolean("desativado")});
                    }
            ...
            try{
                    String SQL = "call listaEditorasDesativadas";
                    while(Conexao.getResultSet(SQL).next()){
                        modelo.addRow(new Object[]{Conexao.getRsInt("idEditora"), Conexao.getRsString("nome"), Conexao.getRsString("endereco"), Conexao.getRsLong("telefone"), Conexao.getRsString("site"), Conexao.getRsBoolean("desativado")});
                    }
                }catch(SQLException ex){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaEditora().setVisible(true);
            }
        });
    }
